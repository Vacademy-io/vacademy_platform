...
public interface AssessmentSlideTrackedRepository extends JpaRepository<AssessmentSlideTracked, String> {
    @Modifying
    @Transactional
    @Query("DELETE FROM AssessmentSlideTracked a WHERE a.activityLog.id = :activityId")
