...
public class QueryServiceImpl implements QueryNodeHandler.QueryService {
    ...
    public Map<String, Object> execute(String prebuiltKey, Map<String, Object> params) {
        ...
        switch (prebuiltKey) {
            ...
            case "getAbandonedMandatePlans":
                return getAbandonedMandatePlans(params);
    ...
    /**
     * Learners who started an enrolment but never completed the mandate -- the audience for the
     * abandoned-mandate follow-up. One row per learner, carrying the invite code they last chose
     ...
     */
    private Map<String, Object> getAbandonedMandatePlans(Map<String, Object> params) {
        try {
            ...
            List<Object[]> rows = ssigmRepo.findAbandonedMandatePlans(instituteId, minAgeDays, maxAgeDays);
            ...
            return Map.of("abandonedMandateList", abandonedList,
                    "abandonedMandateCount", abandonedList.size());
        } catch (Exception e) {
            log.error("Error executing getAbandonedMandatePlans", e);
            return Map.of("error", e.getMessage());
        }
    }
