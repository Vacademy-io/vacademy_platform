            ...
            <html>
              ...
              <body>
                ...
                <script>
                  ...
                  // Accept element OR selector so they work in both the shadow-DOM
                  // render server (dispatcher pre-resolves to elements) and the
                  // iframe browser player (selectors resolve via document). Never throw.
