...
|-----------|---------|------------------------|
| Short video (1-3 min, Gemini Flash) | ~24 | ~250 videos |
...
A typical short video (Gemini Flash) costs ~24 credits, broken down as:
...
A 10-minute video uses ~2x more tokens and ~2x more images → ~48 credits.
...
|-----------------|--------|
| "How much per video?" | ₹22-45 depending on length |
| "₹5,700 gets me how many videos?" | ~125-250 videos |
| "Can I try before buying?" | Yes, 100 free credits on signup (~4 videos) |
| "What if credits run out mid-generation?" | Pre-flight check prevents starting. If it fails mid-way, full refund. |
| "Which model should I use?" | Gemini Flash (Standard) — best price/quality. Upgrade to Pro for complex topics. |
