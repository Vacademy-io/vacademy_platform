...
public class NotificationConstant {
    ...
    public static final String SEND_OTP = "/notification-service/internal/v1/send-otp"; // Unified endpoint for
                                                                                        // email/WhatsApp
    public static final String VERIFY_OTP = "/notification-service/internal/v1/verify-otp"; // Unified endpoint for
                                                                                            // email/WhatsApp
