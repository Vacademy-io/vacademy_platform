...
export const TemplateEditor: React.FC<TemplateEditorProps> = ({
    ...
    // Descriptions for the canonical TEMPLATE_VARIABLES catalog only — every key here has a real
    // backend resolver (bulkEmailService.ts / UnifiedSendService), so nothing shown here is dead.
