...
// LOCAL: lead-scoring endpoints overridden to LOCAL_ADMIN_CORE_BASE for local testing.
// Revert by replacing LOCAL_ADMIN_CORE_BASE → BASE_URL on this block.
...
export const GET_USER_LEAD_PROFILE = `${LOCAL_ADMIN_CORE_BASE}/admin-core-service/v1/audience/user-lead-profile`;
export const GET_USER_LEAD_PROFILES_BATCH = `${LOCAL_ADMIN_CORE_BASE}/admin-core-service/v1/audience/user-lead-profiles/batch`;
export const MARK_LEAD_CONVERTED = `${LOCAL_ADMIN_CORE_BASE}/admin-core-service/v1/audience/user-lead-profile/mark-converted`;
export const UPDATE_LEAD_STATUS = `${LOCAL_ADMIN_CORE_BASE}/admin-core-service/v1/audience/user-lead-profile/update-status`;
export const UPDATE_LEAD_TIER = `${LOCAL_ADMIN_CORE_BASE}/admin-core-service/v1/audience/user-lead-profile/update-tier`;
export const ASSIGN_COUNSELOR_TO_LEAD = `${LOCAL_ADMIN_CORE_BASE}/admin-core-service/v1/audience/user-lead-profile/assign-counselor`;
export const GET_USER_AUDIENCES = `${LOCAL_ADMIN_CORE_BASE}/admin-core-service/v1/audience/user-audiences`;
export const GET_CROSS_STAGE_TIMELINE = `${LOCAL_ADMIN_CORE_BASE}/admin-core-service/timeline/v1/student`;
export const CREATE_TIMELINE_EVENT = `${LOCAL_ADMIN_CORE_BASE}/admin-core-service/timeline/v1/event`;
