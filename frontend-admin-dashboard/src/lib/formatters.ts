 ...
 * migrated yet — adopt incrementally.
 */
...
/**
 * Currency in the active locale, honouring the platform's per-currency
 * minor-unit decimals (src/constants/currencies.ts — e.g. JPY has 0).
 */
