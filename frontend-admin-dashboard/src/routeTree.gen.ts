...
const MentorshipMyMentorshipIndexRoute =
  MentorshipMyMentorshipIndexRouteImport.update({
    ...
    import("./routes/mentorship/my-mentorship/index.lazy").then((d) => d.Route),
  )
const MentorshipMentorsIndexRoute = MentorshipMentorsIndexRouteImport.update({
...
const FinancialManagementAdjustmentApprovalsIndexRoute =
  FinancialManagementAdjustmentApprovalsIndexRouteImport.update({
    ...
    import("./routes/financial-management/adjustment-approvals/index.lazy").then(
      (d) => d.Route,
    ),
  )
...
const AudienceManagerCallLogIndexRoute =
  AudienceManagerCallLogIndexRouteImport.update({
    id: "/audience-manager/call-log/",
    path: "/audience-manager/call-log/",
    getParentRoute: () => rootRouteImport,
  } as any).lazy(() =>
    import("./routes/audience-manager/call-log/index.lazy").then(
      (d) => d.Route,
    ),
  )
const AudienceManagerAiIntelligenceIndexRoute =
  AudienceManagerAiIntelligenceIndexRouteImport.update({
    id: "/audience-manager/ai-intelligence/",
    path: "/audience-manager/ai-intelligence/",
    getParentRoute: () => rootRouteImport,
  } as any).lazy(() =>
    import("./routes/audience-manager/ai-intelligence/index.lazy").then(
      (d) => d.Route,
    ),
  )
...
const AdmissionsAdmissionListIndexRoute =
  AdmissionsAdmissionListIndexRouteImport.update({
    id: "/admissions/admission-list/",
    path: "/admissions/admission-list/",
    getParentRoute: () => rootRouteImport,
  } as any).lazy(() =>
    import("./routes/admissions/admission-list/index.lazy").then(
      (d) => d.Route,
    ),
  )
...
const VimEditVideoIdIndexRoute = VimEditVideoIdIndexRouteImport.update({
  id: "/vim/edit/$videoId/",
  path: "/vim/edit/$videoId/",
  getParentRoute: () => rootRouteImport,
} as any).lazy(() =>
  import("./routes/vim/edit/$videoId/index.lazy").then((d) => d.Route),
)
...
const StudyLibraryCoursesCourseDetailsTranslationIndexRoute =
  StudyLibraryCoursesCourseDetailsTranslationIndexRouteImport.update({
    ...
    import("./routes/study-library/courses/course-details/translation/index.lazy").then(
      (d) => d.Route,
    ),
  )
...
const AssessmentAssessmentListOfflineEntryAssessmentIdIndexRoute =
  AssessmentAssessmentListOfflineEntryAssessmentIdIndexRouteImport.update({
    ...
    import("./routes/assessment/assessment-list/offline-entry/$assessmentId/index.lazy").then(
      (d) => d.Route,
    ),
  )
...
declare module "@tanstack/react-router" {
  interface FileRoutesByPath {
    ...
    "/mentorship/my-mentorship/": {
      id: "/mentorship/my-mentorship/"
      path: "/mentorship/my-mentorship"
      fullPath: "/mentorship/my-mentorship/"
      preLoaderRoute: typeof MentorshipMyMentorshipIndexRouteImport
      parentRoute: typeof rootRouteImport
    }
    "/mentorship/mentors/": {
      id: "/mentorship/mentors/"
    ...
    "/audience-manager/call-log/": {
      id: "/audience-manager/call-log/"
      path: "/audience-manager/call-log"
      fullPath: "/audience-manager/call-log/"
      preLoaderRoute: typeof AudienceManagerCallLogIndexRouteImport
      parentRoute: typeof rootRouteImport
    }
    "/audience-manager/ai-intelligence/": {
      id: "/audience-manager/ai-intelligence/"
      path: "/audience-manager/ai-intelligence"
      fullPath: "/audience-manager/ai-intelligence/"
      preLoaderRoute: typeof AudienceManagerAiIntelligenceIndexRouteImport
      parentRoute: typeof rootRouteImport
    }
    "/assessment/question-papers/": {
      id: "/assessment/question-papers/"
    ...
    "/admissions/admission-list/": {
      id: "/admissions/admission-list/"
      path: "/admissions/admission-list"
      fullPath: "/admissions/admission-list/"
      preLoaderRoute: typeof AdmissionsAdmissionListIndexRouteImport
      parentRoute: typeof rootRouteImport
    }
    "/admissions/admission-form/": {
      id: "/admissions/admission-form/"
    ...
    "/vim/reels/new": {
      id: "/vim/reels/new"
      path: "/vim/reels/new"
      fullPath: "/vim/reels/new"
      preLoaderRoute: typeof VimReelsNewRouteImport
      parentRoute: typeof rootRouteImport
    }
    "/templates/edit/$templateId": {
      id: "/templates/edit/$templateId"
    ...
    "/vim/reels/$reelId/": {
      id: "/vim/reels/$reelId/"
      path: "/vim/reels/$reelId"
      fullPath: "/vim/reels/$reelId/"
      preLoaderRoute: typeof VimReelsReelIdIndexRouteImport
      parentRoute: typeof rootRouteImport
    }
    "/vim/edit/$videoId/": {
      id: "/vim/edit/$videoId/"
      path: "/vim/edit/$videoId"
      fullPath: "/vim/edit/$videoId/"
      preLoaderRoute: typeof VimEditVideoIdIndexRouteImport
      parentRoute: typeof rootRouteImport
    }
    "/video-api-studio/edit/$videoId/": {
      id: "/video-api-studio/edit/$videoId/"
