...
const AssessmentDetailsRankMarkTable = ({
    ...
    const { t } = useTranslation('assessmentQuestionsRankMarkTable');
    return (
        <div className="relative">
            <Table className="w-full table-auto">
                <TableHeader className="sticky top-0 z-10 bg-primary-100">
                    <TableRow className="w-full">
                        <TableHead className="w-1/4 rounded-tl-xl">
                            {t('columns.rank')}
                        </TableHead>
                        <TableHead className="w-1/4">{t('columns.marks')}</TableHead>
                        <TableHead className="w-1/4">{t('columns.percentile')}</TableHead>
