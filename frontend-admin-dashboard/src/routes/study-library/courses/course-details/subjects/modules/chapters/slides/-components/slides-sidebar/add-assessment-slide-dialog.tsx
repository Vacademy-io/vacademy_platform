        ...
        >
            <div className="flex items-start justify-between gap-2">
                ...
                <div className="flex shrink-0 items-center gap-1">
                    {row.play_mode && (
                        <span className="rounded bg-neutral-100 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-neutral-600">
                            {row.play_mode}
                        </span>
                    )}
                    <span
...
export const AddAssessmentSlideDialog = ({
        ...
        try {
            ...
            const payload: AssessmentSlidePayload = {
                ...
                assessment_slide: {
                    ...
                    assessment_id: selectedRow.assessment_id,
    ...
    return (
        <div className="flex flex-col gap-3">
            ...
            <div className="max-h-[360px] min-h-[200px] overflow-y-auto rounded-md border border-neutral-200 p-2">
                {isLoading ? (
