...
export const SAMPLE_TEMPLATES: Record<string, SampleEmailTemplate> = {
  ...
  <p style="color:#888;font-size:13px;margin-top:32px">Best regards,<br/>Your Institute Team</p>
</div>`,
    },
  ...
  <p style="color:#888;font-size:13px;margin-top:32px">Best regards,<br/>Your Institute Team</p>
    ...
    email_parents_batch: {
        ...
        variables: ['fullName', 'email', 'parentsEmail'],
        html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:24px;background:#ffffff">
  ...
  <p style="color:#888;font-size:13px;margin-top:32px">See you next time!<br/>Your Institute Team</p>
</div>`,
    },
    ...
    scheduled_fee_reminder: {
        ...
        variables: ['studentName', 'recipientName', 'dueDate', 'remainingAmount', 'amountExpected', 'amountPaid', 'installmentNumber', 'reminderType'],
        html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:24px;background:#ffffff">
  ...
  <p style="color:#888;font-size:13px;margin-top:32px">Best regards,<br/>Your Institute Team</p>
    ...
    scheduled_batch_report: {
        ...
        variables: ['fullName', 'email', 'attendancePercentage', 'sessionsAttended', 'startDate', 'endDate', 'sessionsTableHtml', 'totalDurationMinutes'],
        html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:24px;background:#ffffff">
  ...
  <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:24px;text-align:center;margin:20px 0">
    <div style="font-size:48px;font-weight:bold;color:#16a34a">{{attendancePercentage}}%</div>
    <div style="color:#444;margin-top:8px">Attendance Rate | {{sessionsAttended}} sessions attended | {{totalDurationMinutes}} min total</div>
  </div>
  <h3 style="color:#1e293b;margin-top:24px">Session Details</h3>
  {{sessionsTableHtml}}
  <p style="color:#444;line-height:1.6;margin-top:16px">Keep up the great work! Regular attendance is key to success.</p>
  <p style="color:#888;font-size:13px;margin-top:32px">Best regards,<br/>Your Institute Team</p>
</div>`,
    },
    ...
    scheduled_engagement_summary: {
        ...
        variables: ['fullName', 'attendancePercentage', 'sessionsAttended', 'totalDurationMinutes', 'totalChats', 'totalHandRaises', 'startDate', 'endDate', 'sessionsTableHtml'],
        html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:24px;background:#ffffff">
  ...
  <p style="color:#888;font-size:13px;margin-top:32px">Keep learning!<br/>Your Institute Team</p>
</div>`,
    },
    ...
    scheduled_parents_attendance: {
        ...
        variables: ['fullName', 'attendancePercentage', 'sessionsAttended', 'startDate', 'endDate'],
        html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:24px;background:#ffffff">
  ...
  <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:24px;text-align:center;margin:20px 0">
    <div style="font-size:48px;font-weight:bold;color:#16a34a">{{attendancePercentage}}%</div>
    <div style="color:#444;margin-top:8px">Attendance Rate | {{sessionsAttended}} sessions attended</div>
  </div>
  <p style="color:#444;line-height:1.6">If you have any concerns about attendance, please reach out to us.</p>
  <p style="color:#888;font-size:13px;margin-top:32px">Best regards,<br/>Your Institute Team</p>
</div>`,
    },
