...
module.exports = {
    ...
    safelist: ['catalogue-display', 'catalogue-h1', 'catalogue-h2', 'catalogue-h3', 'catalogue-lead', 'catalogue-card-glass', 'catalogue-card-gradient-border', 'catalogue-card-tinted', 'catalogue-text-gradient', 'catalogue-eyebrow', 'catalogue-carousel-bleed', 'catalogue-hairline-grid', 'catalogue-block-anchor', 'catalogue-measure-start'],
    content: [
        './pages/**/*.{ts,tsx}',
        './components/**/*.{ts,tsx}',
        './app/**/*.{ts,tsx}',
