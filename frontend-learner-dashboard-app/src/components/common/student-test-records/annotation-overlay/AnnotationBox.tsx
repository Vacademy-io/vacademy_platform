...
/**
 * Draw one annotation on top of a rendered pdf.js page. Position is computed by
 * scaling the OCR full_res box by dims.scale. Absolute-positioned inside a
 * wrapper that fills the page element (pointer-events none so text selection
 * still works; each box re-enables clicks for itself).
 */
