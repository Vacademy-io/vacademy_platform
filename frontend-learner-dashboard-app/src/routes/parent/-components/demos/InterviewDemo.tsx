  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-3xl mx-auto w-full space-y-6 pb-20 lg:pb-8">
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
        <ScheduleCard type="Interview" date={interview.scheduled_date} time={interview.scheduled_time} dur={interview.duration_minutes} mode={interview.mode} link={interview.meeting_link} location={interview.location} icon={<VideoCamera size={20} className="text-violet-600 dark:text-violet-400" />} accent="violet" />
      </motion.div>
