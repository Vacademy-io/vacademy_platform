package labor.link.media_service.config;
...
public class WebSecurityConfig {
    ...
    private static final String[] ALLOWED_PATHS = {"/auth/**", "/media/actuator/**", "/media/internal/**", "/internal/**", "/verify/id", "/media/swagger-ui.html", "/media/api-docs/**", "/swagger-ui.html", "/media/swagger-ui/index.html", "/media/v3/api-docs/**", "/media/swagger-ui/**", "/media/webjars/swagger-ui/**"};
    @Autowired
